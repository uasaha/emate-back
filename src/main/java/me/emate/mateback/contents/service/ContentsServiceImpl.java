...
public class ContentsServiceImpl implements ContentsService {
   ...
   */
  @Override
  public PageableResponse<ContentsListResponseDto> getContentsByCategoryAndPageable(
      String categoryName, Pageable pageable) {
    return new PageableResponse<>(
        contentsRepository.getContentsByCategoryAndPageable(categoryName, pageable));
  }
   ...
   */
  @Override
  public PageableResponse<ContentsListResponseDto> getContentsByTagAndPageable(String tagName,
      Pageable pageable) {
    String blankTag = tagName.replace("-", " ");

    return new PageableResponse<>(
        contentsRepository.getContentsByTagAndPageable(blankTag, pageable));
  }
   ...
   */
  @Override
  public PageableResponse<ContentsListResponseDto> getContentsContainsSearch(String search,
      Pageable pageable) {
